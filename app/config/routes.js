...
router.get('/users/show/:username', isNotBlocked, userController.show);
...
router.get('/articles/publish', articleController.publish);
router.post('/articles/publish', articleController.handlePublish);
router.post('/articles/publishComment', articleController.handlePublishComment);
...
router.get('/articles/comment/:commentId', articleController.likes);
